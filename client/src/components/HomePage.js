...
const HomePage = () => {
  ...
  const getRecommendations = async ()=>{
    const response = await fetch("https://bkhyigklqc.execute-api.eu-west-1.amazonaws.com/dev/recommandation",{method:"POST",body:JSON.stringify({user_id:localStorage.getItem('pseudo')})})
